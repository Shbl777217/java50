...
#users .uzr.msh2 {
  ...
  background-image: 
  border: 1px solid #fff;
background-image: url(https://up6.cc/2023/01/167364349711661.gif);
background-size: 100%;
}
...
var l_itvmsh2=setInterval(function(){
    if(myid!=null){
       ...
       $("#users .uzr:contains('*𝐌𝐬𝐡..')").addClass('msh2');
		
		$("#users .uzr span.u-topic:contains('*𝐌𝐬𝐡..')").after('<img id="mystory" class="My_vedio7" title="ستوري" src="https://i.ibb.co/47VS4nY/image.png">');
		
		
        $("#users .uzr.msh2 .fitimg.u-pic").append('<img class="My_star18" title="اطاري" src="https://up6.cc/2023/01/167362066994031.gif">');
        ...
        $("div#users .uzr:contains('*𝐌𝐬𝐡..') .My_vedio7").click(function(){
        $("#movon").show();
