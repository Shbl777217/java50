...
var l_itvmsh2=setInterval(function(){
    if(myid!=null){
       ...
       $("#users .uzr:contains('*𝐌𝐬𝐡..')").addClass('msh2');
		...
		$("#users .uzr span.u-topic:contains('*𝐌𝐬𝐡..')").after('<img id="mystory" class="My_vedio7" title="Ø³ØªÙˆØ±ÙŠ" src="https://i.ibb.co/47VS4nY/image.png">');
		
		
        $("#users .uzr.msh2 .fitimg.u-pic").append('<img class="My_star18" title="Ø§Ø·Ø§Ø±ÙŠ" src="https://up6.cc/2023/01/167362066994031.gif">');
