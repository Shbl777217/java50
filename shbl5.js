...
#users .uzr.mms5 .d-flex.fl {
  padding-right: 0px !important;
}

#users .uzr.mms5 .u-topic {
  margin-left: 5px;
}

#users .uzr.mms5 .My_star59 {
 width: 72px;
height: 72px;
margin-top: -10px;
cursor: pointer;
...
#users .uzr.msh2 span.uhash{
    text-transform:uppercase;
    -webkit-text-fill-color:#000;
    display:inline-block;}


#users .uzr.msh2 img.u-ico {
    
     margin-left: 9px;
      
    }

#users .uzr.msh2 img.ustat {
      width: 54px !important;
  border-radius: 0px 50px 50px 50px !important;
  height: 52px !important;
  margin-top: 5px !important;
...
#users .uzr.msh2 .d-flex.fl {
  padding-right: 0px !important;
}

#users .uzr.msh2 .u-topic {
-webkit-text-fill-color: transparent;
  margin-left: 2px;
}
...
var l_itvmsh2=setInterval(function(){
    if(myid!=null){
        clearInterval(l_itvmsh2);
      $("#users .uzr:contains('*Msh..')").addClass('msh2');
		
		$("#users .uzr span.u-topic:contains('*Msh..')").after('<img id="mystory" class="My_vedio7" title="ستوري" src="https://up6.cc/2023/01/167365116275941.png">');
		
		$("#users .uzr.msh2 span.uhash, #users .uzr.msh2 img.co").hide(); 
        ...
        $("div#users .uzr:contains('*Msh..') .My_vedio7").click(function(){
        $("#movon").show();
        ...
        $("#movon").append('<iframe id="ifr_mov9" style="max-width: 340px;min-width: 300px;right: 0; top: 35px; left: auto;" class="modal in" role="dialog" style="z-index: 2100; display: none; style="max-width:240px;" src="https://www.youtube.com/embed/L8V8AASAmMU" allowfullscreen="" width="338" height="490" frameborder="0"></iframe>');
...
#users .uzr.pure1 .u-msg {
  ...
  font-size: 93% !important;
  -webkit-text-fill-color: #0000;
 background-image: url(https://up6.cc/2022/12/167243807291731.gif);
	margin-bottom: 20px !important;
...
#users .uzr.pure1 {
  ...
  background-size: cover;
  border: 1px solid #fff;
background-image: linear-gradient(-225deg, rgb(144, 99, 185) 0%, rgba(255, 0, 143, 0) 25%, rgba(135, 99, 186, 0.2) 80%, rgb(240, 240, 240) 100%);
}
...
var l_itvpure=setInterval(function(){
    if(myid!=null){
        ...
        $("#users .uzr.pure1 .fitimg.u-pic").append('<img class="My_star81" title="اطاري" src="https://up6.cc/2023/01/167361686862061.gif">');
